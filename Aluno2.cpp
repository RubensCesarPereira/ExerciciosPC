...
int main(int argc, char** argv) {
	...
	std::cout << "Nota 1 do aluno 1 na variavel:" << endl;
	...
	std::cout << "Nome do aluno 2: " << endl;
	std::cout << aluno2.getNome() << std::endl;
	std::cout << "-------------------------------------" << endl;

	std::cout << "RA do aluno 2: " << endl;
	std::cout << aluno2.getRA() << std::endl;
	std::cout << "-------------------------------------" << endl;

    int teste;
	std::cout << "Numero de notas do aluno 2: " << endl;
	teste = aluno2.getNroNotas();
	std::cout << teste << std::endl;
	std::cout << "-------------------------------------" << endl;

	//----------------- ERRO, a nota sai sempre 1  --------------------
	std::cout << "Nota 1 do aluno 2: " << endl;
	double nota2;
	...
	std::cout << "Nota 4 do aluno 2 na variavel:" << endl;
